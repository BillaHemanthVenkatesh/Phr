										...
										<td class="text-right">
											<div class="dropdown dropdown-action">
												...
												<div class="dropdown-menu dropdown-menu-right">
													<a class="dropdown-item" href="view-bphistory.php?viewid=<?php echo ($row->ID);?>"><i class="fa fa-pencil m-r-5"></i> View</a>
													<a class="dropdown-item" href="manage-history-bp.php?delid=<?php echo ($row->ID);?>" data-toggle="modal"><i class="fa fa-trash-o m-r-5"></i> Delete</a>
												</div>
											</div>
										</td>
									</tr>
