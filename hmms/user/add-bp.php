...
$query->bindParam(':pulses',$pulses,PDO::PARAM_STR);
 ...
 $query->execute();
   ...
   if ($LastInsertId>0) {
    echo '<script>alert("Blod Pressure Detail Has Been Added.")</script>';
echo "<script>window.location.href ='recomendbp.php'</script>";
  }
  else
    {
...
<head>
    ...
    <title>PERSONAL HEALTH RECORD MANAGEMENT  - Add Blood Pressure</title>
    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
            <div class="content">
                <div class="row">
                    <div class="col-sm-12">
                        <h4 class="page-title">Add Blood Pressure Details</h4>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card-box">
                            <h4 class="card-title">Add Blood Pressure Details</h4>
                            <form method="post">
...
<option value="<?php echo htmlentities($row->ID);?>"><?php echo htmlentities($row->FullName);?></option>
 <?php } ?> 
                                 ...
                                 <div class="form-group row">
                                    <label class="col-form-label col-md-2">SYS<small>mmHg</small></label>
                                    <div class="col-md-10">
                                ...
                                <div class="form-group row">
                                    <label class="col-form-label col-md-2">DIA<small>mmHg</small></label>
                                    <div class="col-md-10">
                                        <input type="text" class="form-control" value="" name="dia" required="true">
                                    </div>
                                </div>
                                 <div class="form-group row">
                                    <label class="col-form-label col-md-2">Pulses <small>/min</small></label>
                                    <div class="col-md-10">
