...
<body>
   ...
   <div class="page-wrapper" style="min-height: 515px;">
            <div class="content">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="card-box">
                            ...
                            <form method="post">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10">
                                        <input type="file" value="" name="fname" required="true" class="form-control">
                                    </div>
                                </div>
                                 <div class="form-group row">
                                    <label class="col-form-label col-md-2">Sugar Report</label>
                                    <div class="col-md-10">
                                        <input type="file" value="" name="age" required="true" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10">
                                        <input type="file" class="form-control" value="" name="weight" required="true">
                                    </div>
                                </div>
                                <div class="form-group row">
