...
<head>
    ...
    <title>PERSONAL HEALTH RECORD MANAGEMENT - Dashboard</title>
...
<h3 style="text-align: center;color: red">Welcome to Personal Health Record <?php  echo $row->FullName;?></h3>
    <?php $cnt=$cnt+1;}} ?>
							</div>
                        </div>
                    </div>
