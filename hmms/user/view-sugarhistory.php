            ...
            <div class="content">
                <div class="row">
                    ...
                    <div class="col-sm-8 col-9 text-right m-b-20">
                        <a href="add-bp.php" class="btn btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Add Sugar</a>
                    </div>
                </div>
				<div class="row">
					<div class="col-md-12">
...
<?php $cnt=$cnt+1;}} ?>
   <tr>
    <tr>
  <th colspan="4" style="color: blue;font-weight: bold;font-size: 15px"> History of Sugar Monitoring:</th>
</tr>
<tr>
 ...
 <?php
    ...
    $vid=$_GET['viewid'];            
$sql="SELECT * from tblsugar where MemberID=:vid";
$query = $dbh -> prepare($sql);
$query-> bindParam(':vid', $vid, PDO::PARAM_STR);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
