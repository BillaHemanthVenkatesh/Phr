...
$query->bindParam(':eid',$eid,PDO::PARAM_STR);
 ...
 $query->execute();
   ...
   echo '<script>alert("test range has been updated")</script>';
...
<head>
    ...
    <title>PERSONAL HEALTH RECORD MANAGEMENT  - Update Testing Range</title>
    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
            <div class="content">
                <div class="row">
                    <div class="col-sm-12">
                        <h4 class="page-title">Update Testing Range Details</h4>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card-box">
                            <h4 class="card-title">Update Testing Range Details</h4>
                            <form method="post">
                               <?php
$eid=$_GET['editid'];
...
<option value="Body Temparature">Body Temparature</option>
