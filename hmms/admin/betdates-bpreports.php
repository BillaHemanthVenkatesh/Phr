...
<head>
    ...
    <title>PERSONAL HEALTH RECORD MANAGEMENT - B/W Dates Report of Blood Pressure</title>
    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
            <div class="content">
                <div class="row">
                    <div class="col-sm-12">
                        <h4 class="page-title">B/W Dates Report of Blood Pressure</h4>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card-box">
                            <h4 class="card-title">B/W Dates Report of Blood Pressure</h4>
